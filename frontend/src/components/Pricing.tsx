                ...
                className={`group relative flex flex-col bg-gray-900 border transition-all duration-300 rounded-[2rem] p-8 md:p-10 hover:-translate-y-3 hover:ring-1 ${
                  tier.popular
                    ...
                    : tier.tier === currentTier && isRegistered
                      ? 'border-emerald-500/40 shadow-xl shadow-emerald-500/5 bg-emerald-500/5 hover:scale-[1.03] hover:border-emerald-500/60 hover:shadow-[0_30px_60px_-15px_rgba(16,185,129,0.2)] hover:ring-emerald-500/30'
                      : 'border-white/5 hover:border-white/20 hover:bg-gray-800/40 hover:scale-[1.03] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)] hover:ring-white/10'
