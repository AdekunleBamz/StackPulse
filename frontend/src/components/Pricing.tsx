        ...
        <div id="pricing-tiers" className="scroll-mt-24 mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 md:gap-8 lg:gap-8 items-stretch">
            {tiers.map((tier, index) => (
              <div
                key={index}
                className={`group relative flex flex-col bg-gray-900 transition-all duration-300 rounded-[2rem] p-8 md:p-10 hover:-translate-y-3 hover:ring-1 ${
                  tier.popular
                    ? 'border-2 border-purple-500/50 shadow-[0_20px_50px_-20px_rgba(168,85,247,0.15)] scale-[1.02] hover:scale-[1.05] z-10 bg-gradient-to-br from-gray-900 via-gray-900 to-purple-900/10 hover:shadow-[0_30px_70px_-15px_rgba(168,85,247,0.4)] hover:border-purple-400 hover:ring-purple-500/30'
                    : tier.tier === currentTier && isRegistered
                      ? 'border border-emerald-500/40 shadow-xl shadow-emerald-500/5 bg-emerald-500/5 hover:scale-[1.03] hover:border-emerald-500/60 hover:shadow-[0_30px_60px_-15px_rgba(16,185,129,0.2)] hover:ring-emerald-500/30'
                      : 'border border-white/5 hover:border-white/20 hover:bg-gray-800/40 hover:scale-[1.03] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)] hover:ring-white/10'
